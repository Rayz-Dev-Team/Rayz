...
async def on_command_error(ctx, error):
    if isinstance(error, (commands.CommandNotFound)):
        ...
        try:
            em = guilded.Embed(title="An error has occured trying to process your command.", description="`-` Screenshot this, and [send it to the developer](https://www.guilded.gg/i/E0LaMb4E)\n\n{}".format(error), color=0x363942)
